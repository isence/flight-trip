...
jQuery(document).ready(function() {
	...
	function initDayList (days){
		for (var i = days - 1; i >= 0; i--) {
			$('.day-container').before('<div class="destination day-container"> <i class="u1 ui-circle-green fn-click-empty"></i> <ul class="list destination-list day-list ui-sortable"> <li class="title"> <h3 class="bg-green clearfix"> <span class="convert-block"> 第<span class="day-sequence">'+i+'</span>天 <em> (<span class="count">0</span>) </em> </span> <strong class="date-msg"> </strong> </h3> </li></ul></div>');
		}
	}
	//初始化加入行程列表的天数
