...
jQuery(document).ready(function() {
	...
	$(function(){
            ...
            $('#origin-add-menu').hover(function() {
            }, function() {
                $(this).hide();
            });
            //加入行程
        ...
        function searchFlight(){
            ...
            var data = { "homecity_name": homecity_name,"getcity_name": getcity_name};
            $.ajax({
                url:'/searchFlight',
                type:'POST',
                data:data,
